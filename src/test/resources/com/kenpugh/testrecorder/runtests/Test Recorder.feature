Feature: Test Recorder
  ...
  Scenario: Set test status
    Given test exists
      | Issue ID | Sub Issue ID | Name              | Runner | Last Result | Date Last Run            | Date Previous Result | File Path               | Comments    | Test Status |
      | 12345    | 678          | Enter test result | Sam    | Success     | Oct 1, 2022, 12:30:01 AM | Never                | EnterTestResult.feature | Works great | Active      |
    When test is selected
      | Issue ID     | 12345 |
      | Sub Issue ID | 678   |
    And test is changed
    ...
    And test is now
      | Issue ID | Sub Issue ID | Name              | Runner | Last Result | Date Last Run            | Date Previous Result | File Path               | Comments    | Test Status |
      | 12345    | 678          | Enter test result | Sam    | Success     | Oct 1, 2022, 12:30:01 AM | Never                | EnterTestResult.feature | Works great | Inactive    |
